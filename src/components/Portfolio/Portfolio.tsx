        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p><a href="https://fake-news-detection-vr.vercel.app/"> Login </a></p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>Html</li>
        ...
        {/* <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/vigneshrajavel/CRUD-Nodejs"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img src={externalLinkIcon} alt="Visitar site" />
            ...
            <div className="body">
              <h3>CRUD Using Node js </h3>
              <p><a href="http://localhost:4200"> Click Here </a></p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>Node js</li>
